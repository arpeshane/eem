...
public abstract class BaseProgramDataEntity {
			@Id
			@Column(name="id")
			private long id;
			...
			public BaseProgramDataEntity(long id) {
				super();
				this.id = id;
			}
			

			public BaseProgramDataEntity(long id, int ssactiveagents, int ssactivelastthirtydays,
					int ssactivelastsevendays, int totalagent, int totalagentparticipating, int mtdactiveagent,
					int wtdactiveagent, int currentdayactivegent, int activelastthirtydays, int activelastsevendays,
					int extrahrreqapproved, int extrahrreqdeclined, int extrahrreqrtcwaiting,
					int extrahrreqautoapproved, double extrahrhoursapproved, double extrahrhoursdeclined,
					double extrahrhoursrtcwaiting, double extrahrhourautoapproved, double extrahrrulercmdagent,
					double extrahrrtcapproved, double extrahragtaccepted, double extrahragtdecliend,
					double extrahragtnores, int vtoreqapproved, int vtoreqdeclined, int vtoreqrtcwaiting,
					int vtoreqautoapproved, double vtohoursapproved, double vtohoursdeclined, double vtohoursrtcwaiting,
					double vtohourautoapproved, double vtohourrulercmdagent, double vtohourrtcapproved,
					double vtohouragtaccepted, double vtohouragtdecliend, double vtohouragtnores, int ptoreqapproved,
					int ptoreqdeclined, int ptoreqautoapproved, double ptohoursapproved, double ptohourautoapproved,
					double ptohoursdeclined, int ttlswap, double ttlswaphr, int tradereq, int ttltrade_accepted,
					double ttltradehr, double schedulehr, int ahtalert, Date aux1, Date aux2, Date aux3, Date aux4,
					Date aux5, Date aux6, Date aux7, Date aux8, Date aux9, double loginhoursactual, int abandonedcalls,
					int answeredcalls, double acw, double talktime, double ahtactual, double occupancy,
					double servicelevel, int successrecordsinwfm, int failedrecordsinwfm, int programid,
					String programname, Date reportdate, Date ctzdatetime, String timezone) {
				super();
				this.id = id;
			...
			public String toString() {
				return "WorkflexConcentricProgram [id=" + id + ", ssactiveagents=" + ssactiveagents
						+ ", ssactivelastthirtydays=" + ssactivelastthirtydays + ", ssactivelastsevendays="
						+ ssactivelastsevendays + ", totalagent=" + totalagent + ", totalagentparticipating="
						+ totalagentparticipating + ", mtdactiveagent=" + mtdactiveagent + ", wtdactiveagent="
						+ wtdactiveagent + ", currentdayactivegent=" + currentdayactivegent + ", activelastthirtydays="
						+ activelastthirtydays + ", activelastsevendays=" + activelastsevendays + ", extrahrreqapproved="
						+ extrahrreqapproved + ", extrahrreqdeclined=" + extrahrreqdeclined + ", extrahrreqrtcwaiting="
						+ extrahrreqrtcwaiting + ", extrahrreqautoapproved=" + extrahrreqautoapproved
						+ ", extrahrhoursapproved=" + extrahrhoursapproved + ", extrahrhoursdeclined="
						...
						+ ", vtohouragtnores=" + vtohouragtnores + ", ptoreqapproved=" + ptoreqapproved
						+ ", ptoreqdeclined=" + ptoreqdeclined + ", ptoreqautoapproved=" + ptoreqautoapproved
						+ ", ptohoursapproved=" + ptohoursapproved + ", ptohourautoapproved=" + ptohourautoapproved
						+ ", ptohoursdeclined=" + ptohoursdeclined + ", ttlswap=" + ttlswap + ", ttlswaphr=" + ttlswaphr
						+ ", tradereq=" + tradereq + ", ttltrade_accepted=" + ttltrade_accepted + ", ttltradehr="
						+ ttltradehr + ", schedulehr=" + schedulehr + ", ahtalert=" + ahtalert + ", aux1=" + aux1
						+ ", aux2=" + aux2 + ", aux3=" + aux3 + ", aux4=" + aux4 + ", aux5=" + aux5 + ", aux6=" + aux6
						+ ", aux7=" + aux7 + ", aux8=" + aux8 + ", aux9=" + aux9 + ", loginhoursactual=" + loginhoursactual
						+ ", abandonedcalls=" + abandonedcalls + ", answeredcalls=" + answeredcalls + ", acw=" + acw
						+ ", talktime=" + talktime + ", ahtactual=" + ahtactual + ", occupancy=" + occupancy
						+ ", servicelevel=" + servicelevel + ", successrecordsinwfm=" + successrecordsinwfm
						+ ", failedrecordsinwfm=" + failedrecordsinwfm + ", programid=" + programid + ", programname="
						+ programname + ", reportdate=" + reportdate + ", ctzdatetime=" + ctzdatetime + ", timezone="
						+ timezone + "]";
			}
